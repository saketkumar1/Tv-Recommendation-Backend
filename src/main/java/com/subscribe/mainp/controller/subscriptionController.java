...
public class subscriptionController {
	...
	@DeleteMapping("/remove/{subsid}")
	public ResponseEntity<ApiResponse> removeSubscription(@PathVariable long subsid) {
		this.subsService.deleteSubscription(subsid);
		return new ResponseEntity<ApiResponse>(new ApiResponse("Subscription Deleted Successfully", true), HttpStatus.OK);
	}
