...
public class WatchlistController {
    ...
    @GetMapping("/getSize/{userid}")
    public ResponseEntity<Integer> getSize(@PathVariable int userid) {
        int wSize = this.watchlistService.getWatchListSize(userid);
        return ResponseEntity.ok(wSize);
    }
}
